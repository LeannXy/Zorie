        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="border border-gray-200 rounded-lg p-6 sticky top-32">
                            <h3 class="text-xl font-bold text-gray-900 mb-6">Menu Akun</h3>
                            <nav class="space-y-2">
                            ...
                            <div class="border border-gray-200 rounded-lg p-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" placeholder="Tambahkan nomor telepon Anda" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-400">
                                    </div>
                                </div>

                                <div class="mt-8">
                                    <h3 class="text-lg font-bold text-gray-900 mb-4">Tanggal Lahir</h3>
                        ...
                        <div id="orders-tab" class="tab-content hidden">
                            <div class="border border-gray-200 rounded-lg p-8">
                                ...
                                <div class="text-center py-12">
                                    ...
                                    <h3 class="text-gray-900 font-semibold mb-2">Belum ada pesanan</h3>
                                    <p class="text-gray-600 text-sm mb-4">Mulai berbelanja untuk melakukan pesanan pertama Anda</p>
                            ...
                            <div class="border border-gray-200 rounded-lg p-8">
                                ...
                                <div class="space-y-6">
                                    <div class="pb-6 border-b border-gray-200">
                                        <h3 class="text-lg font-bold text-gray-900 mb-3">Preferensi Email</h3>
                                        <label class="flex items-center cursor-pointer">
                                            <input type="checkbox" checked class="w-4 h-4 rounded">
                                            <span class="ml-3 text-sm text-gray-700">Terima email promosi</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer mt-3">
                                            <input type="checkbox" checked class="w-4 h-4 rounded">
                                            <span class="ml-3 text-sm text-gray-700">Terima pembaruan pesanan</span>
                                        </label>
                                    </div>

                                    <div class="pb-6 border-b border-gray-200">
                                        <h3 class="text-lg font-bold text-gray-900 mb-3">Keamanan Akun</h3>
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-gray-900 mb-3">Zona Bahaya</h3>
                        ...
                        <div id="saved-addresses-tab" class="tab-content hidden">
                            <div class="border border-gray-200 rounded-lg p-8">
                                ...
                                <div class="text-center py-12">
                                    ...
                                    <h3 class="text-gray-900 font-semibold mb-2">Tidak ada alamat tersimpan</h3>
                                    <p class="text-gray-600 text-sm">Tambahkan alamat untuk membuat checkout lebih cepat</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Selamat Datang di Akun Anda</h2>
                    <p class="text-gray-600 mb-8">Silakan masuk atau buat akun untuk mengakses profil Anda</p>
