<header x-data="{ scrolled: false, cartCount: 0 }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 60);
fetch('{{ route('cart.count') }}')
    .then(r => r.json())
    .then(d => cartCount = d.count);" class="fixed top-0 left-0 w-full z-50 pointer-events-none">

    {{-- CONTAINER --}}
    <div class="mx-auto mt-4 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] pointer-events-auto"
        :class="scrolled
            ?
            'max-w-[360px]' :
            'max-w-[1280px]'">
        ...
        {{-- NAVBAR --}}
        <div class="bg-white/80 backdrop-blur-2xl border border-[#ececec] shadow-[0_10px_40px_rgba(0,0,0,0.05)] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]"
            :class="scrolled
                ?
            ...
            <div class="flex items-center justify-between h-full">
                ...
                <div class="flex items-center">
                    ...
                    <a href="/" class="shrink-0">
                        ...
                        <h1 class="leading-none text-[#111] transition-all duration-500 font-[800] tracking-[-2px] uppercase"
                    ...
                    {{-- NAVIGATION --}}
                    <nav class="hidden lg:flex items-center transition-all duration-300 overflow-hidden"
                        :class="scrolled
                            ?
                            'opacity-0 w-0 ml-0' :
                ...
                <div class="flex items-center transition-all duration-500"
                    ...
                    <a href="{{ route('cart') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-[#777] transition-all duration-500"
                            :class="scrolled
                                ?
                                'w-[15px] h-[15px]' :
                                'w-[17px] h-[17px]'"
